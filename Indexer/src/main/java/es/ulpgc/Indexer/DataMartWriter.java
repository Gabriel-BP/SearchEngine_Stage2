...
public class DataMartWriter {
    private static final String CONTENT_DATAMART_DIR = "/app/shared/datamart_content";
    private static final String METADATA_DATAMART_DIR = "/app/shared/datamart_metadata";
